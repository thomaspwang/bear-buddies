                ...
                <div className={styles.body}>
                    ...
                    <div className={styles.info}>
                        ...
                        <div className={styles.iconText}>
                            ...
                            <p id={styles.para}>Moffitt Library</p>
                        </div>
                        <div className={styles.iconText}>
                            ...
                            <p id={styles.para}>Come study with me for this midterm! Currently stuck on heapification. If you have any advice I'd really appreciate it, I have no idea what i'm doing</p>
                        </div>
                    </div>
                </div>
